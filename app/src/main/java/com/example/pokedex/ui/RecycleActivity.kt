...
class RecycleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sprites = Sprites(Other(OfficialArtwork("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/4.png")))
        val type = listOf(PokemonTypeSlot(1,Type("water","")),PokemonTypeSlot(0,Type("fire","")))
